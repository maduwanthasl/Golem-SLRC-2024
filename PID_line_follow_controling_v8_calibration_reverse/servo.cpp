...
void servo_setup() {
  MG995.attach(11);  // attaches the servo on pin 10 to the MG995 servo object
  MG90.attach(10);   // attaches the servo on pin 11 to the MG90 servo object
...
void mg90_open(){ //80-140 80 .140 initial
